            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 mt-10 ">
                {
                    news.map((article, index) => (
                        <div key={index} className="w-full max-w-xs shadow-md hover:scale-105 hover:shadow-blue-300 transition-all duration-300 shadow-blue-200 border-1 rounded-lg flex flex-col gap-8 relative px-6 py-4">
