...
export default function Navbar(){
    return(
        <div className="fixed top-0 left-0 right-0 z-10 flex flex-row px-4 sm:px-8 md:px-12 bg-white rounded-xl shadow-md shadow-blue-200 h-[80px] md:h-[100px] justify-between items-center">
